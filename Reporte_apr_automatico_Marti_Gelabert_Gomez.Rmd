...
<b>Nota:</b> Se comentarán los problemas que ha habido con respecto a los resultados obtenidos en kaggle y el código que no se muestre en el reporte por razones esteticas estará disponible tanto en el directorio principal
</div>
-->
...
Con los datos normalizados pasaremos a tener una desviación estandar (de cada columna) de 1, como podremos ver a continuación:
